...
#ifndef NOWHERETORUN_INPUTKEYS_H
#define NOWHERETORUN_INPUTKEYS_H

#include <GLFW/glfw3.h>

namespace Cygine
{
    // Redefine glfw3 keys with proper names
    enum KeyboardKey
    {
        ...
        NUMPAD_DOT = GLFW_KEY_KP_DECIMAL,
...
#endif //NOWHERETORUN_INPUTKEYS_H
